...
namespace EmployeeMGT.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,EmployeeFirstName,EmployeeLastName,EmployeeDateOfBirth,EmployeeDepartment")] Employee employee)
        {
